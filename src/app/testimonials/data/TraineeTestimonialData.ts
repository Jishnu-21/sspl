...
export const traineeTestimonials: TraineeTestimonial[] = [
  ...
  },
  {
    ...
    text: 'This is my first internship, which I thoroughly enjoyed during the period of six month training. Now, I have very valuable experience under my belt. I had learned how to work in a team. Another aspect that I had learned throughout my internship is to never be afraid to ask lots of questions. Under the guidance of Nishith Sir, I had learned that how to deal in tough situation with patience and always smile. Also learnt how to deal with live projects, and give proper naming and structure to the project. Whenever I stuck during any project, then Priyanka Ma’am helps me to understand the technical things and also helps me by giving multiple solutions to one problem. So this internship give me a lot of things which I cannot imagine as I have got friendly colleagues, a good mentor (Priyanka Ma’am and Nishith Sir) who guides me how to deal in any situation and also gives solution whenever needed. So, this experience is my asset and it would be increased in future also.',
    name: 'Ms. Sonia Malik',
    course: ''
  },
  {
