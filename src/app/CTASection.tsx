      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <motion.a 
              href="/contact"
              className="inline-block px-6 sm:px-8 py-3 border-2 border-white text-white font-medium rounded-lg hover:bg-white hover:text-[#0f2756] transition-all duration-300"
              variants={fadeIn}
              whileHover={{ 
                scale: 1.05,
