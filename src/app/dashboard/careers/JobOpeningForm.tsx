...
export default function JobOpeningForm({ form, onChange, onSubmit, loading, success, error }: JobOpeningFormProps) {
  return (
    <form onSubmit={onSubmit} className="bg-white/90 rounded-2xl shadow-lg p-6 md:p-8 flex flex-col gap-5 border border-gray-100">
      ...
      <div>
        ...
        <textarea name="description" value={form.description} onChange={onChange} rows={3} className="w-full border border-gray-200 rounded-lg px-3 py-2 text-black focus:ring-2 focus:ring-green-400 focus:border-green-400 transition" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-gray-700 font-medium mb-1">Requirements <span className="text-xs text-gray-400">(comma separated, e.g. React, Node.js)</span></label>
        ...
        <div>
          <label className="block text-gray-700 font-medium mb-1">Benefits <span className="text-xs text-gray-400">(comma separated, e.g. Health Insurance)</span></label>
      ...
      <div>
        ...
        <textarea name="whoWeAre" value={form.whoWeAre} onChange={onChange} rows={2} className="w-full border border-gray-200 rounded-lg px-3 py-2 text-black focus:ring-2 focus:ring-green-400 focus:border-green-400 transition" />
      </div>
