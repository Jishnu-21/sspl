...
export default function JobOpeningForm({ form, onChange, onSubmit, loading, success, error }: JobOpeningFormProps) {
  return (
    <form onSubmit={onSubmit} className="bg-white/90 rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 flex flex-col gap-4 sm:gap-5 border border-gray-100 w-full max-w-2xl mx-auto">
