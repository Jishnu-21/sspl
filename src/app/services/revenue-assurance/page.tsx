  ...
  return (
    ...
    <PageBanner
        ...
        />
            ...
            <section className="max-w-6xl mx-auto mb-12" data-aos="fade-up">
            <p className="text-gray-700 leading-relaxed">
            ...
            <section className="py-8 px-4 md:px-8 max-w-6xl mx-auto mb-4" data-aos="fade-up">
              <div className="text-center">
                <h2 className="text-2xl font-semibold text-[#366A00] ">SSPL has been working in providing revenue assurance solutions and services for various Banks, Insurance, Retail and Telecom Companies.</h2>
              </div>
            </section>
