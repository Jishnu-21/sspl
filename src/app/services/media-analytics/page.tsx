...
import PartnersScroll from '@/app/components/PartnersScroll';
import AOS from 'aos';
...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon: Icon, title, description, delay = 0 }) => (
  <div
    className="bg-[#1B3D69] p-6 rounded-md min-w-[300px] md:min-w-[350px] group transition-all duration-300 shadow-md flex flex-col items-center hover:scale-105 hover:shadow-lg hover:bg-[#366A00] cursor-pointer"
    data-aos="zoom-in"
...
const media = () => {
  ...
  const featureCards = [
    ...
    },
    {
      ...
      description:
        'It provides out-of-the-box pointers for VOD and linear TV based on the customer preferences, their viewing history and compares it to the same parameters with similar users in a different domain.'
    },
    {
      icon: FaUsers,
      ...
      <main className="flex flex-col bg-white min-h-screen">
        ...
        <section className="py-4 px-4 md:px-8 max-w-7xl mx-auto" data-aos="fade-up">
          <div className="max-w-6xl mx-auto mb-2">
            <p className="text-gray-700 leading-relaxed text-justify">
              An unprecedented amount of data is being generated from enormous video traffic that presents an array of
              opportunities and challenges for the Channel. Media Analytics proposes a solution to manage and take
              appropriate business decisions, at almost real-time basis. SSPL- with its given track record of over 20
              years in the Industry of Data Analytics provides extremely fast, tested and trusted solution to various
              businesses that detail out Business Intelligent Reports and Trends based on the user defined parameters.
              The solution and services not only enables Channels to understand their viewers better, but also helps
              them optimize the airtime with best possible telecast.
            </p>
          </div>
        ...
        <section className="py-4 px-4 md:px-8 max-w-7xl mx-auto" data-aos="fade-up">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold text-[#366A00] mb-6">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-stretch gap-8">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center" data-aos="fade-left">
                <p className="text-gray-700 leading-relaxed text-justify">
                  SSPL's Media Analytics enabling software solution can be leveraged to build offerings to understand
                  the user behavior. Our solution generates audience engagement measurements and is capable of
                  supporting structured as well as non-structured data from all possible sources in the Industry. The
                  framework enables a user to run descriptive, predictive and prescriptive analytics over the collected
                  data. It helps in generating reports, charts and dashboards that provide insights into customer
                  behavior. The solution also implements a recommendation engine to suggest movies and programs based on
                  user's viewing history and preferences. It also provides a forecasting engine to estimate revenue
                  generated through customer activity.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-4 bg-gray-50 overflow-hidden relative" data-aos="fade-up">
          <div className="mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-700 max-w-4xl mx-auto mb-10 text-justify">
        ...
        <PartnersScroll
          ...
          items={[
            { caption: 'Gain Actionable Insights', useIcon: true, icon: FaChartArea },
            { caption: 'Gain Competitive Advantage', useIcon: true, icon: FaChartPie },
            { caption: 'Mitigate Risks Effectively', useIcon: true, icon: FaShieldAlt },
            { caption: 'Extensive Product Engineering Experience', useIcon: true, icon: FaCogs },
            { caption: 'Domain-Specific Solutions', useIcon: true, icon: FaGlobe },
